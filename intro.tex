...
In other news, the straightforward approach for data dissimination  of  \gloss{BitTorrent} had successfully been  implemented for web content distribution by \gloss{ZeroNet} \cite{zeronet}. However, because of the aforementioned issues with BitTorrent, ZeroNet turned out unable to support the  responsivenes that users of web services have come to expect.
...
The lack of control over one's data has serious consequences on the economic potential of the users. Some refer to this situation, somewhat hysterically, as \gloss{data slavery}. But they are technically correct: our digital twins are being captive to corporations, put to good use for them, without us having any agency, quite to the contrary, to manipulate us out of it and make us less well informed and free. 
