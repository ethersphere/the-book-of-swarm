...
The batches are created by a central postage smart contract when a transaction is sent to its creation endpoint, together with an amount of Honey tokens and the following transaction data:
