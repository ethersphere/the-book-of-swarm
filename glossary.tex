...
\longnewglossaryentry{chunk value}{name=chunk value}{The chunk value is determined  by the price of the postage batch it is stamped with. It serves to order chunks when a node prioritises for garbbage collection.}
...
\longnewglossaryentry{span value}{name=span value}{TBD Viktor?: An 8 byte of data inside a single owner chunk that determines the length of the payload.}
...
\longnewglossaryentry{prekey bundle}{name=prekey bundle}{Consists of all information the initiator needs about responder to initiate a handshake.}
...
\longnewglossaryentry{fair data economy}{name=fair data economy}{Economy of processing data with fair compensation of all parties involved in its creation of enrichment.}
