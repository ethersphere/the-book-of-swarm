...
We regard (2) and (3) as the core of Swarm. Since the network layer relies on it, we will also formulate the requirements for (1), but we consider the detailed treatment of both (1) and (4) outside the scope of this book.
